...
- [Orkas](https://github.com/Orkas-AI/Orkas) - Open-source, local-first desktop AI workforce whose Commander coordinates specialist agents and local coding agents through one chat. `TypeScript` `MIT`
